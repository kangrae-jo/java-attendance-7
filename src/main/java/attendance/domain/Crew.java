...
public class Crew {
    ...
    private final Map<LocalDate, ArrivalTime> attendance;

    private Crew(String name, Map<LocalDate, ArrivalTime> attendance) {
        this.name = name;
        this.attendance = attendance;
    }

    public void attend(LocalDate today, ArrivalTime arrivalTime) {
